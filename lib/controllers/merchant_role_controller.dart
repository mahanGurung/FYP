...
import 'package:final_year_project/models/merchant_role.dart';
...
class MerchantController extends GetxController {
  ...
  List<RoleMerchant> merchantsList = RxList.empty();
  @override
  void onInit() {
  ...
  Future<void> get() async {
    ...
    if (decodedResponse["success"]) {
      ...
      for (var merchant in merchants) {
        merchantsList.add(RoleMerchant.fromJson(merchant));
      }
      print(merchantsList);
